  ...
  return (
    <>
      ...
      {props.restaurantData.map((restaurant, index) => (
        <TouchableOpacity key={index} ractiveOpacity={1} style={{ marginBottom: 30 }} 
        onPress={() =>navigation.navigate('RestaurantDetail', {
          // send the following data to RestaurantDetail
...
const RestaurantInfo = (props) => (
  ...
  >
    <View>
      ...
      <Text style={{ fontSize: 13, color: 'gray' }}>30-35·min</Text>
    </View>
